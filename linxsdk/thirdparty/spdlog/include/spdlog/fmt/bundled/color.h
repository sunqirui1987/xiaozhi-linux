...
private:
    ...
    static FMT_CONSTEXPR bool has_emphasis(emphasis em, emphasis mask) FMT_NOEXCEPT {
...
template <typename Char>
void vformat_to(buffer<Char>& buf, const text_style& ts, basic_string_view<Char> format_str,
...
template <typename OutputIt, typename S, typename... Args,
          bool enable =
              detail::is_output_iterator<OutputIt, char_t<S>>::value&& detail::is_string<S>::value>
