...
public:
    ...
    template <class T, typename std::enable_if<
                           !is_convertible_to_any_format_string<const T&>::value, int>::type = 0>
    void log(source_loc loc, level::level_enum lvl, const T& msg) {
        log(loc, lvl, "{}", msg);
    }

    void log(log_clock::time_point log_time, source_loc loc, level::level_enum lvl,
             string_view_t msg) {
...
protected:
    ...
    void log_(source_loc loc, level::level_enum lvl, wstring_view_t fmt, Args&&... args) {
        ...
        SPDLOG_TRY {
            ...
            fmt::detail::vformat_to(
                wbuf, fmt,
                fmt::make_format_args<fmt::wformat_context>(std::forward<Args>(args)...));
#endif
    ...
    template <class T,
              typename std::enable_if<std::is_convertible<const T&, spdlog::wstring_view_t>::value,
                                      int>::type = 0>
